...
\begin{position}
    ...
    \location{Tavannes}
    \duration{Ao\^ut 2019 - Mars 2020}
    \description{-\,D\'evelopement d'une solution pour superposer des \'elements virtuels sur une flux vid\'eo dans un casque de VR.}
\end{position}\\
\begin{position}
    \employer{\href{https://chainsolutions.com/}{chainSolutions}}
    \title{Blockchain Consultant}
    \location{Z\"urich}
    \duration{Jan' - Juin 2018 @ $\sim$ 10\%}
    \description{-\,Design d'architecture de diff\'erents services pour des clients avec un focus sur l'identit\'e digitiale d\'ecentralis\'ee et la confidentialit\'e}
\end{position}\\
\begin{position}
    ...
    \description{
        -\,Ajout de module en Python \`a l'ERP \href{https://www.odoo.com/}{Odoo}. Fonctionnement Agile et travail \href{https://github.com/CompassionCH/compassion-switzerland}{open-source}.
    }
\end{position}\\
\begin{position}
...
\begin{position}
    ...
    \description{
        -\,D\'eveloppement de graphiques personnalisables pour analyser les statistiques au sein de l'\'equipe Architecture Security.Impl\'ementation en Java et AngularJS.\par
    }
\end{position}\\
\sectionline
...
\cusemph{Languages de programmation}: Python, Java, Matlab, \LaTeX\\
...
\begin{project}
  ...
  \description{
    - Comme l'un des gagnants de l'\href{https://blogs.ethz.ch/ETHambassadors/2018/07/26/coding-challenge-inside-bloomberg/}{ETH CodeCon}, participation \`a un projet d'une semaine au sein du \href{https://www.bloomberg.com/careers/technology/}{CTO Office} consistant \`a l'analyse et la d\'etection d'anomalies dans les traces r\'eseaux de microservices.
  }
\end{project}\\
\begin{project}
...
\begin{project}
  ...
  \location{CMU}
  \description{
	-\,Automatisation d'un chauffage \'electrique d'appoint profitant des p\'eriodes d'absence pour \'economiser de l'\'energie sans impacter le confort.\par
