...
\end{itemize}
%-------------------------------------------------------------------------------
\cusemph{Maturité billingue (Allemand/Français)}
\timeline{2010--2013}\\
...
\begin{research}
    ...
    \description{%
      ...
      milliars de conversions. Nous déployons notre prototype sur Chromium. Bâti
      ...
      compétences techinques, rédactionelles, et stratégique, par exemple, sur l'articulation
...
\begin{research}
    ...
    \description{%
      ...
      %
      \item Pour l'évauation multifacettes ainsi que le design de \textsc{libErator}, 
      j'ai du anticiper les complexités futurs et comprendre de manière transversales les caractéristiques des sytèmes.
      %
    }
\end{research}
\begin{research}
    ...
    \description{%
      ...
      si le type de destination est pas l'original, peuvent amenés à la corruption de la mémoire.
      %
      \item En étendant la protection de type++ à tout les types, Sourcerer est le premier sanitizer complet pour ces erreurs. 
      Avec un ralnetissement de seulement 5\% en moyenne, nous conduisons la première campagne de fuzzing visant spécifiquement les confusions de types.
      %
      ...
      %
      \item Comme auteur principal, j'ai conçu l'architecture de Sourcerer et pris en charge l'évaluation et l'écriture de l'article.
      }
\end{research}
\begin{research}
...
\begin{position}
    ...
    \description{
      \item Lors de mon service civil, dévelopement, au sein d'un environement Agile, d'une surchouche visuelle  pour pouvoir détonner des mines avec une pelleteuse télécomandée.  
    }
\end{position}
\begin{position}
...
\begin{position}
    ...
    \title{Analyste Techologique Stagiaire}
    \location{London, UK}
...
\begin{extra}
  ...
  \location{'23--présent}
  \description{%
    \item Définition de la stratégie, participation au processus de recrutement, et planification budégtaire ($\simeq$ 500kCHF).
  }
\end{extra}
\begin{extra}
  ...
  \description{
    \item Direction de plusieurs camps avec jusqu'à 110 enfants/jeunes adultes durant une semaine. Recruement d'une équipe,
...
\begin{extra}
  ...
  \description{
    ...
    \item Nous avons travaillée ensemble dans des comités d'engagement, pour le budget et la stratégie générale.
  }
\end{extra}
