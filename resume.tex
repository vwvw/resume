...
- Curious by nature, I love to understand vulnerabilities and their security implications.\\
- Through monitoring, data analysis, I hope to reduce the repercussion of APT incidents.\\
...
%-------------------------------------------------------------------------------
\section{Talks}
\cusemph{\href{https://www.blackalps.ch/ba-25/}{BlackAlps}}: No App? No Problem: Automatic Library Fuzzing
\hfill
