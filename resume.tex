...
\begin{position}
    ...
    \description{
      ...
      secure dialects, compiler passes and automated testing, we
      bring higher security guarantees to large code bases effortessly. 
      %
...
\begin{position}
    ...
    \description{
      \item Created a virtual reality overlay to extend the range of a remote
      \href{https://digger-dtr.com/en/products/digger-scraper/}{explosive
      detonation digger}.
    }
\end{position}
\begin{position}
    ...
    \description{
        ...
        modules for the \href{https://www.odoo.com/}{Odoo ERP}.
    }
\end{position}
\begin{position}
    ...
    \description{
        \item Deisgned and developped a blackbox fuzzer to find bugs in a
...
\begin{extra}
  ...
  \description{
    \item Lead week-long camps with up 110 kids/young adults. Built a team,
    prepared the event, managed the team and was the bearer of authority.
  }
\end{extra}
