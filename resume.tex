...
\begin{position}
    ...
    \description{
        -\,Design d'architecture pour diff\'erents services pour des clients avec un focus sur la confidentialit\'e.\\
        \hspace{-1.1ex}-\,Refl\'ections autour de la gestion d'identit\'e digitale.}
\end{position}\\
\begin{position}
...
\begin{position}
    ...
    \description{
        -\,D\'eveloppement de graphiques personnalisables pour analyser les statistiques au sein de l'\'equipe Architecture Security.\\
        \hspace{-1.1ex}-\,Identification des graphiques pertinents et des besoins du management. Impl\'ementation en combinant deux sources de donn\'ees diff\'erentes.\\
        \hspace{-1.1ex}-\,Backend construit en Java avec myBatis, frontend en AngularJS et Highcharts.
    }
\end{position}\\
\sectionline
...
\begin{project}
  ...
  \description{
	...
	-\,\'Ecrit en Python et publi\'e avec Docker sous la supervsion de  \textcolor{darkgray}{\href{https://nebelwelt.net/}{Prof. Mathias Payer}}
  }
\end{project}
\begin{project}
...
\begin{project}
  ...
  \description{
	...
	-\,Projet effectu\'e dans le cadre de l’introduction \`a la recherche sous la supervision de \textcolor{darkgray}{\href{http://arthurgervais.com/}{Prof. Arthur Gervais}}.\\
  }\\
\end{project}
\begin{project}
...
\begin{project}
  ...
  \location{CMU}
  \description{
	-\,Programmation d’un syst\`eme de communication digital capable d’envoyer plusieurs dizaines de milliers de bits par seconde sans erreur.\par
	-\,\'Ecrit en Matlab dans le but de d\'ecouvrir diff\'erents principes de communication digitale.\\
  }\\
\end{project}\\
\sectionline
%-------------------------------------------------------------------------------
