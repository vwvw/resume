...
Passionate about cybersecurity, my curiosity is driven to its ever evolving nature.

%My natural curiosity drives me to spot and try to understand odd patterns. 

With automated defenses and monitoring, I want to diminish the repercussion of cyber incident.
%I believe that security of complex systems can be improved.

By shifting left security in the SDLC, I strive to reduce the attack surface of software.
...
Can-do attitude and strong ability to adapt to changing requirements.
...
\begin{position}
    ...
    \description{
      \item Lead the development and evaluation of different security tools
      reducing the attack surface of C/C++ code. With novel
      defenses across the software development lifecycle and both static and dynamic/automated security testing during CI/CD, we
      improve security guarantees of large code bases.
      %
      \item Facing continuously evolving requirements, I strategically scoped our
      projects and deployed them in a reproducible and automated manner.
      %
...
%-------------------------------------------------------------------------------
\section{Skills}
\cusemph{Programming Languages}: Python, Bash, C++, \LaTeX.

\cusemph{Software}: LLVM, Docker, GDB, Linux, Make, afl++, libfuzzer, ansible.
