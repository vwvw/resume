...
\section{Experience}
\begin{position}
    \employer{\href{https://swissgrid.ch}{SwissGrid}}
    \title{Cyber Security Specialist}
    \location{Aarau, CH}
    \duration{Dec' 2025--ongoing}
    \description{
      \item Techinical point of contact for the security champions embeded in the development teams.

    }
\end{position}
\begin{position}
    \employer{\href{https://hexhive.ch}{HexHive @ EPFL}}
    \title{PhD Researcher}
    ...
    \description{
      ...
      %
      \item In a diverse team, I lead projects with senior professors and designed and mentored
...
\cusemph{Doctorate of Sciences (PhD)}
...
%-------------------------------------------------------------------------------
\section{Talks}
\href{https://www.blackalps.ch/ba-25/talks.php#52}{No App? No Problem: Automatic Library Fuzzing} @ \cusemph{\href{https://www.blackalps.ch/ba-25/}{BlackAlps}}
\hfill
\textit{Nov' 2025}\\
\href{https://www.ndss-symposium.org/ndss-paper/type-prohibiting-type-confusion-with-inline-type-information/}{\texttt{type++}: prohibiting type confusion with inline type information} @ \cusemph{\href{https://www.ndss-symposium.org/ndss2025/}{NDSS}}
\hfill
\textit{Feb' 2025}
