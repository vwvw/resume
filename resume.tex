...
Passionate about cybersecurity, I am looking for a R&D role tackling the evolving nature of software security.
%Constant curiosity for complex systems to understand their weak points. 
With automated defenses and monitoring, I hope to devise solutions to mitigate the repercussion of cyber incidents.
...
%-------------------------------------------------------------------------------
\section{Talks}
\cusemph{\href{https://www.blackalps.ch/ba-25/}{BlackAlps}}: No App? No Problem: Fuzzing Libraries
\hfill
